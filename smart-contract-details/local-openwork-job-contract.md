...
| <p>User should be able to post a Job<br>Max. 10K USD per Job</p> | <p><code>postJob() {</code><br>Calls <code>postJob()</code> function on the Native OpenWork Contract through the bridge contract<br>}</p>                                           |
